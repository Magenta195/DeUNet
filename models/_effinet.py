...
from ._effinet_layer import conv_bn_act
from ._effinet_layer import SamePadConv2d
from ._effinet_layer import Flatten
from ._effinet_layer import SEModule
from ._effinet_layer import DropConnect
...
def efficientnet_models(num_classes: int):
    return EfficientNet(width_coeff = 1, depth_coeff = 1, num_classes = num_classes)